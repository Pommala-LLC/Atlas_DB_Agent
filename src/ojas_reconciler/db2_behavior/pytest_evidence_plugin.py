"""Deprecated Ojas pytest evidence plugin compatibility wrapper.

New release evidence uses :mod:`atlas.pytest_evidence_plugin`.
"""
...
def pytest_addoption(parser: pytest.Parser) -> None:
    group = parser.getgroup("ojas-release-evidence")
    group.addoption("--ojas-evidence-json", action="store", default=None, help="Write structured Ojas pytest evidence JSON.")
